<div class="row">
                <div class="col-md-12">
                   <center> <h4 class="page-head-line">Selamat Datang Di Sistem Perpustakaan SDN Itssulthony</h4></center>
                </div>
...
<div class="row">
                ...
                <div class="col-md-6">
                      <div class="notice-board">
                        <div class="panel panel-info">
                        <div class="panel-heading">
                            Perpustakaan SDN Itssulthony 
                        </div>
                                <div class="panel-body">
                                <ul align="justify">
                                Untuk mendukung kelancaran proses beajar-mengajar dan meningkatkan kualitas pendidikan siswa di SDN Itssulthony telah menyediakan beragam buku dengan beragam kategori yang dapat dimanfaatkan siswa
